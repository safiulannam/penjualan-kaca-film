        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-user fa-fw"></i> Data Pelanggan</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="pelanggan_tambah.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Pelanggan</button></a>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"> 
                                                    <a href="pelanggan_hapus.php?kode_pelanggan=<?php echo $row["kode_pelanggan"]; ?>" 
                                                ...
                                                <a href="pelanggan_edit.php?kode_pelanggan=<?php echo $row["kode_pelanggan"]; ?>" >  
