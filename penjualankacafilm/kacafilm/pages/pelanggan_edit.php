...
if (isset($_POST["edit_pelanggan"])){
    if (editpelanggan($_POST) > 0){
        echo "
        <script>
        alert('Data Pelanggan Berhasil Di Edit');
        document.location.href = 'pelanggan.php';
        </script>";
    } else {
        echo "
        <script>
        alert('Data Pelanggan Gagal Di Edit');
        document.location.href = 'pelanggan.php';
        </script>";
    }
}
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class ="form-group">
                            ...
                            <input type="text" name="kode_pelanggan" class="form-control" id="kode_pelanggan" value="<?php echo $pelanggan["kode_pelanggan"]; ?>" readonly="">
                         </div>

                        <div class ="form-group">
                            <label for ="nama_pelanggan">Nama Pelanggan</label>
                            <input type="text" name="nama_pelanggan" class="form-control" id="nama_pelanggan" value="<?php echo $pelanggan["nama_pelanggan"]; ?>" required="" autofocus="" autocomplete="off">
                        </div>

                        <div class ="form-group">
                            <label for ="telepon">Telepon</label>
                            <input type="text" name="telepon" class="form-control" id="telepon" value="<?php echo $pelanggan["telepon"]; ?>" required="" autofocus="" autocomplete="off">
                        </div>

                        <div class ="form-group">
                            <label for ="alamat">Alamat</label>
                            <textarea class="form-control"name="alamat" id="alamat" value="<?php echo $pelanggan["alamat"]; ?>" required="" ></textarea>
                        </div>

                        <div class ="form-group">
                            <label for ="email">Email</label>
                            <input type="text" name="email" class="form-control" id="email" value="<?php echo $pelanggan["email"]; ?>" required="" autofocus="" autocomplete="off">
                        </div>
                    
                        <button type="submit" class="btn btn-primary" name="edit_pelanggan">Edit</button>
                            </div>
