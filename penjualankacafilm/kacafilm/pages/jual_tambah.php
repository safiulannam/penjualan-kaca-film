...
$urutan = (int) substr($kodejual , 3, 3);
$urutan++;
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-users fa-fw"></i>Tambah Penjualan</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        ...
                        <div class ="form-group">
                            ...
                            <input type="text" name="kode_jual" class="form-control" id="kode_jual" value="<?php echo $kodejual; ?>" readonly="">
                         </div>
                        ...
                        <div class ="form-group">
                            ...
                            <input type="text" name="kode_user" class="form-control" id="kode_user" required autofocus autocomplete="off">
                        </div>

                        <div class ="form-group">
                            <label for ="kode_pelanggan">Kode Pelanggan</label>
                            <input type="text" name="kode_pelanggan" class="form-control" id="kode_pelanggan" required autofocus autocomplete="off">
                        </div>

                        <div class ="form-group">
                            <label for ="total">Total</label>
                            <input type="text" name="total" class="form-control" id="total" required autofocus autocomplete="off">
                        </div>
                    
                        <button type="submit" class="btn btn-primary" name="tambah_jual">Simpan</button>
                            </div>
