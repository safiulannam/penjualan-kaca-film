                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="barang_tambah.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Barang</button></a>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"> 
                                                    <a href="barang_hapus.php?kode_barang=<?php echo $row["kode_barang"]; ?>" 
                                                ...
                                                <a href="barang_edit.php?kode_barang=<?php echo $row["kode_barang"]; ?>" >  
